...
class SettingProduct extends Page
{
    protected static ?string $navigationLabel = 'Product Page';
    protected static ?string $navigationGroup = 'Site Settings';
    protected static string $view = 'filament.pages.site-setup.setting-product';
    public ?array $formData = [];
    public function mount(): void
    {
        $json_string = file_get_contents('../page-content.json');
        $json_array = json_decode($json_string, true);
        $loadData = $json_array["page-product"];
        $arr= [
            "jumbotron" => [
    ...
    public function submit(): void
    {
        ...
        $json_string = file_get_contents('../page-content.json');
        $json_array = json_decode($json_string, true);
        $json_array['page-product']["title-page"]=$formData['page_setup']['title-page'];
        $json_array['page-product']["keywords-seo"]=$formData['page_setup']['keywords-seo'];
        $json_array['page-product']["description-seo"]=$formData['page_setup']['description-seo'];
        $json_array['page-product']["jumbotron"]=$formData["jumbotron"];
